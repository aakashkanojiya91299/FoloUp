      ...
      <div className="flex flex-col bg-gray-200 rounded-md min-h-[120px] p-2 pl-4">
        ...
        <div className="flex flex-row justify-between">
          ...
          <div className="flex flex-row gap-3">
            <Button
              disabled={isClicked}
              className="bg-[#06546e] hover:bg-[#06546e]/80 mt-2"
              onClick={() => {
                setIsClicked(true);
                onSave();
              }}
          ...
          <div className="flex items-center cursor-pointer">
            ...
            <Switch
              ...
              className={`ml-4 mt-1 border-2 border-gray-300 ${
                isAnonymous ? "bg-[#06546e]" : "bg-white"
              }`}
        ...
        <ScrollArea className="flex ml-2 p-2 pr-4 mb-4 flex-col justify-center items-center w-[75%] max-h-[500px] bg-slate-100 rounded-md text-sm mt-3">
          ...
          {questions.length < numQuestions ? (
            <div
              className="border-[#06546e] opacity-75 hover:opacity-100 w-fit text-center rounded-full mx-auto"
              onClick={handleAddQuestion}
            >
              <Plus
                size={45}
                strokeWidth={2.2}
                className="text-[#06546e] text-center cursor-pointer"
              />
            </div>
          ) : (
            <></>
