...
export class IntervieweeService {
  ...
  static async createInterviewee(
    data: Omit<Interviewee, "id" | "created_at" | "updated_at">,
  ): Promise<Interviewee> {
  ...
  static async getIntervieweesByOrganization(
  ...
  static async getIntervieweesByInterview(
    interviewId: string,
  ): Promise<Interviewee[]> {
    const { data: interviewees, error } = await supabase
      .from("interviewees")
  ...
  static async updateInterviewee(
    id: string,
    data: Partial<Interviewee>,
  ): Promise<Interviewee> {
    const { data: interviewee, error } = await supabase
      .from("interviewees")
      .update({
  ...
  static async getResumesByInterviewee(
    intervieweeId: string,
  ): Promise<Resume[]> {
  ...
  static async getResumeAnalysis(
    resumeId: string,
  ...
  static async getResumeAnalysesByInterview(
    interviewId: string,
  ): Promise<ResumeAnalysis[]> {
  ...
  static async createJobRequirements(
    data: Omit<ATSJobRequirements, "id" | "created_at" | "updated_at">,
  ): Promise<ATSJobRequirements> {
  ...
  static async getJobRequirementsByOrganization(
    organizationId: string,
  ): Promise<ATSJobRequirements[]> {
    const { data: requirements, error } = await supabase
      .from("ats_job_requirements")
  ...
  static async getJobRequirementsByInterview(
    interviewId: string,
  ): Promise<ATSJobRequirements[]> {
    const { data: requirements, error } = await supabase
      .from("ats_job_requirements")
  ...
  static async getInterviewsByOrganization(
    organizationId: string,
  ): Promise<any[]> {
